...
<c:if test="<%= true %>">
	...
	//javax.portlet.PortletURL portletURL = null;//renderResponse.createRenderURL();
	  javax.portlet.PortletURL portletURL = renderResponse.createRenderURL();
	%>
...
<p class="search-total-label text-default">
	About <%= searchResultsMapDisplayContext.getTotal() %> results for <strong><%= searchResultsMapDisplayContext.getKeywords() %></strong>
</p>
